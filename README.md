...
1. * look for which model you are using. most of the time its under the stand
   * this is myn 
	- ![](https://github.com/deadkiyo/downgrading-microsoft-surface/blob/main/WhatsApp.jpeg)
2.  then go to [https://support.microsoft.com/en-us/surface-recovery-image] to download the iso 
